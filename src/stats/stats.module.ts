...
import { GeneralStatsNetwork, GeneralStatsNetworkSchema } from './schema/generalStatsNetwork.schema';
...
@Module({
  ...
  providers: [StatsService, SubgraphService, PriceService, StatsNetworkService, ChainConfigService, BitqueryService],
  exports: [SubgraphService, PriceService, StatsNetworkService, StatsService],
