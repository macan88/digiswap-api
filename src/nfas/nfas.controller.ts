import { Controller, Get, Param, Query, Logger, Post, Body, UseInterceptors, CacheInterceptor } from '@nestjs/common';
...
export class NfasController {
  ...
  @ApiExcludeEndpoint()
  @Get('address/:address')
  async getNfasByAddress(@Param('address') address: string, @Query() query): Promise<Nfa[] | null> {
